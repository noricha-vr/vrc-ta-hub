...
from community.models import Community, CommunityInvitation, CommunityMember
...
class AcceptInvitationView(View):
    ...
    def get(self, request, token):
        ...
        if request.user.is_authenticated and invitation.community.is_manager(request.user):
    ...
    def get_context_data(self, **kwargs):
        ...
        if community:
            context['lt_application_template_display'] = (
                community.lt_application_template
