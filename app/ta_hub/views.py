...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            # vket_achievements は request.build_absolute_uri() に依存するためキャッシュ外で毎回生成する。参照: PR #336（理由・背景の追跡）
    ...
    def _build_database_context(self, today, cache_key):
        ...
        # データをキャッシュに保存（1時間）
        # vket_achievements は request に依存するためキャッシュに含めない。参照: PR #336（理由・背景の追跡）
        cache_data = {
