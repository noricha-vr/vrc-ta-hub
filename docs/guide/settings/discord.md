...
description: Discord Webhookを設定して、イベントや発表申請の通知を受け取る方法を説明します。
---
...
| イベント | 通知内容 |
|----------|----------|
| 発表申請 | 申請者名、テーマ、対象イベント |
| 発表申請の承認 | 承認された発表の情報 |
| 発表申請の却下 | 却下された発表の情報と理由 |
| イベント登録 | イベント名、日時、場所 |
...
1. Discordの「ユーザー設定」→「詳細設定」→「開発者モード」をオンにする
2. 対象のロールまたはユーザーを右クリック
3. 「IDをコピー」を選択
4. コピーしたIDを設定画面に貼り付け
